...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNoBoleto = (EditText) findViewById(R.id.txtNoBoleto);
        ...
        btnLimpiar = (Button) findViewById(R.id.btnNuevo);
        ...
        btnImprimir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txtNoBoleto.getText().toString().matches("") || txtNombre.getText().toString().matches("") ||
                    ...
                    Toast.makeText(MainActivity.this, "Faltan campos por completar",Toast.LENGTH_LONG).show();
                } else{
                    int noBoleto = Integer.parseInt(txtNoBoleto.getText().toString());
                    ...
                    lblImpresion.setText("* * *  * * * * * * * Agencia de viajes El Destino Feliz * * * * * * * * *  " +
                            "\n                                        DESCRIPCION                                        " +
                            "\nNo°Boleto:  " + Boleto.getNoBoleto() +
        ...
        btnLimpiar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lblImpresion.getText().toString().matches("")){
                    Toast.makeText(MainActivity.this, "Favor de llenar los datos",Toast.LENGTH_LONG).show();
                } else {
                    txtNoBoleto.setText("");
                    txtNombre.setText("");
                    txtEdad.setText("");
